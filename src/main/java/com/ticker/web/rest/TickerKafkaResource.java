...
@RestController
@RequestMapping("/api/ticker-kafka")
public class TickerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TickerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TickerKafkaResource(KafkaProperties kafkaProperties) {
