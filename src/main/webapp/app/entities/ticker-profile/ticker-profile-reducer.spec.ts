...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TICKERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TICKERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TICKERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TICKERPROFILE actions', async () => {
      const expectedActions = [
        {
