...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ticker.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TICKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TICKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TICKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TICKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TICKER actions', async () => {
      const expectedActions = [
        {
